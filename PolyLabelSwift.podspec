#
#  Be sure to run `pod spec lint PolyLabelSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/nicolasmarchal/polylabel-swift"
  ...
  spec.source       = { :git => "https://github.com/nicolasmarchal/polylabel-swift.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "PolyLabelSwift/**/*.{swift}"
